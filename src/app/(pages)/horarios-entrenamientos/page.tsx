      ...
      <section className="section-wrap">
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_18px_40px_var(--shadow-card-a08)]">
          <div className="grid grid-cols-[1fr] border-b border-slate-200 bg-slate-50 px-5 py-4 md:grid-cols-[180px_1fr]">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--black)]">Día</p>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--black)]">Turnos</p>
          </div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {row.slots.map((slot) => (
                  <span
                    key={slot}
                    className="inline-flex items-center rounded-full border border-[var(--accent-a20)] bg-[var(--accent-a10)] px-3 py-1 text-sm font-semibold text-[var(--black)]"
                  >
                    {slot}
                  </span>
                ))}
