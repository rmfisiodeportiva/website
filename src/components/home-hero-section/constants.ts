export const homeHeroSectionContent = {
  eyebrow: "Rehab Strength · Molina de Segura",
  supportingText: "Centro de fisioterapia y rendimiento con enfoque clínico y progresión de fuerza.",
  image: {
